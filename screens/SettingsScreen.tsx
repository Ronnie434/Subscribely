...
export default function SettingsScreen() {
  ...
  const { isConnected, error: realtimeError } = useRealtimeSubscriptions(
    user?.id,
    {
    ...
    useCallback(() => {
      const refreshStatus = async () => {
        try {
          ...
          console.error(
            "Error refreshing subscription status on focus:",
            error
          );
        }
      };
  ...
  const shouldShowProfilePhoto =
    useProfilePhoto && profileData?.avatar_url && !imageLoadError;
  ...
  const handleContactSupport = async () => {
    ...
    const email = "support@therenvo.com";
  ...
  const handleClearCache = () => {
    ...
    Alert.alert(
      "Clear Local Cache",
      "Are you sure you want to clear the local cache? This will remove temporary data.",
      [
        {
          text: "Cancel",
          style: "cancel",
  ...
  // Handler to show the delete account modal
  ...
  // Handler to perform the actual account deletion
  const handleDeleteAccount = async () => {
    try {
      setIsDeleting(true);

      // Call the mark-account-deleted Edge Function
                ...
                <>
                  ...
                  <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoValue}>
                      {subscriptionStatus.currentCount} of{" "}
                      {subscriptionStatus.maxAllowed} used
                    </Text>
                  </View>
                </>
              )}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            ...
            >
              ...
              <Text style={[styles.actionLabel, styles.actionLabelBlue]}>
                Contact Support
              </Text>
              <Ionicons
                name="chevron-forward"
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <View style={[styles.actionIconContainer, styles.actionIconRed]}>
                <Ionicons
              ...
              <Text style={[styles.actionLabel, styles.actionLabelRed]}>
                Delete Account
              </Text>
              <Ionicons
                name="chevron-forward"
            ...
            >
              <View
                style={[styles.actionIconContainer, styles.actionIconOrange]}
              >
                <Ionicons name="trash-outline" size={22} color="#FF9500" />
              </View>
              <Text style={[styles.actionLabel, styles.actionLabelOrange]}>
                Clear Local Cache
              </Text>
              <Ionicons
                name="chevron-forward"
       ...
       {/* Sign Out Button - Close to top */}
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Made with ❤️ for recurring item management
          </Text>
        </View>
      </ScrollView>
                ...
                <View style={styles.themeOptionContent}>
                  ...
                  >
                    <Ionicons
                      ...
                      size={24}
                      color={
                        themeMode === "light" ? "#FFFFFF" : theme.colors.primary
                      }
                    />
                  </View>
                ...
                <View style={styles.themeOptionContent}>
                  ...
                  >
                    <Ionicons
                      ...
                      size={24}
                      color={
                        themeMode === "dark" ? "#FFFFFF" : theme.colors.primary
                      }
                    />
                  </View>
                  <View style={styles.themeOptionTextContainer}>
                ...
                <View style={styles.themeOptionContent}>
                  ...
                  >
                    <Ionicons
                      ...
                      size={24}
                      color={
                        themeMode === "auto" ? "#FFFFFF" : theme.colors.primary
                      }
                    />
                  </View>
                  <View style={styles.themeOptionTextContainer}>
