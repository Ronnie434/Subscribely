...
export default function EmailLoginScreen() {
  ...
  const navigateToForgotPassword = () => {
    if (__DEV__) {
      console.log('[EmailLoginScreen] navigateToForgotPassword called');
    }
    try {
      if (navigation?.navigate) {
        if (__DEV__) {
          console.log('[EmailLoginScreen] Using React Navigation to navigate to ForgotPassword');
        }
        navigation.navigate('ForgotPassword');
      } else {
        if (__DEV__) {
          console.error('[EmailLoginScreen] No navigation method available!');
        }
      }
    } catch (error) {
      if (__DEV__) {
        console.error('[EmailLoginScreen] Navigation error:', error);
      }
    }
  };
